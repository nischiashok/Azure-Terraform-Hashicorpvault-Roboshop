...
resource "null_resource" "ansible" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "ansible-pull -i localhost, -U https://github.com/nischiashok/Azure-Roboshop-Terraform-ansible.git roboshop.yml -e app_name=${var.name} -e role_name=${var.name} -e env=dev -e  token=${var.token}"
